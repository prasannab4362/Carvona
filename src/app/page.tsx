  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 flex flex-col items-center gap-16 relative z-10">
          {/* Hero text */}
          <div className="text-center max-w-3xl flex flex-col items-center gap-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 animate-pulse">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-text-main leading-tight md:leading-[1.1]">
              Blur or Replace License <br className="hidden md:inline" />
              Plates in <span className="text-primary">Seconds</span>
            </h1>
            
            <p className="text-lg text-text-muted max-w-xl leading-relaxed">
              Automatically detect vehicle license plates using AI. Blur them instantly for free or replace them with your custom dealership logo.
            </p>
          </div>
