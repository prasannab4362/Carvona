    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10 flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          <div className="w-10 h-10 rounded-full overflow-hidden shadow-md shadow-primary/10 group-hover:scale-105 transition-transform duration-300 border border-border-light">
